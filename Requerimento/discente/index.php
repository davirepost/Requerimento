<?php 
    ...
    if(isset($acao)){
        ...
        $consulta = "INSERT INTO requerimento(objeto, data_inicial, `data/hora_regis`, obs, anexos, `status`, turma, discente_matricula, idcurso, email, docente) VALUES ('$objeto','$data_inicial','$data_registro','$obs','$nome_arquivo','$status','$turma','$matricula','$curso','$email', '$docentes')";
